...
# Hierarchical cell: mipi_csi2_rx1
proc create_hier_cell_mipi_csi2_rx1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_mipi_csi2_rx1() - Empty argument(s)!"}
     return
  }
  ...
  set v_frmbuf_wr_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:v_frmbuf_wr:2.0 v_frmbuf_wr_0 ]
  set_property -dict [ list \
  ...
  set v_proc_ss_csc [ create_bd_cell -type ip -vlnv xilinx.com:ip:v_proc_ss:2.0 v_proc_ss_csc ]
  set_property -dict [ list \
  ...
  set v_proc_ss_scaler [ create_bd_cell -type ip -vlnv xilinx.com:ip:v_proc_ss:2.0 v_proc_ss_scaler ]
  set_property -dict [ list \
...
# Hierarchical cell: mipi_csi2_rx0
proc create_hier_cell_mipi_csi2_rx0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_mipi_csi2_rx0() - Empty argument(s)!"}
     return
  }
...
proc create_root_design { parentCell } {
  ...
  set sensor0_iic [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 sensor0_iic ]
  set sensor1_iic [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 sensor1_iic ]

  # Create ports
  set sensor0_gpio_flash [ create_bd_port -dir O -from 0 -to 0 sensor0_gpio_flash ]
  set sensor0_gpio_rst [ create_bd_port -dir O -from 0 -to 0 sensor0_gpio_rst ]
  set sensor0_gpio_spi_cs_n [ create_bd_port -dir O -from 0 -to 0 sensor0_gpio_spi_cs_n ]
  set sensor1_gpio_flash [ create_bd_port -dir O -from 0 -to 0 sensor1_gpio_flash ]
  set sensor1_gpio_rst [ create_bd_port -dir O -from 0 -to 0 sensor1_gpio_rst ]
  set sensor1_gpio_spi_cs_n [ create_bd_port -dir O -from 0 -to 0 sensor1_gpio_spi_cs_n ]
  ...
  # Create instance: mipi_csi2_rx0
  create_hier_cell_mipi_csi2_rx0 [current_bd_instance .] mipi_csi2_rx0

  # Create instance: mipi_csi2_rx1
  create_hier_cell_mipi_csi2_rx1 [current_bd_instance .] mipi_csi2_rx1
  ...
  # Create instance: sensor0_iic, and set properties
  set sensor0_iic [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:2.0 sensor0_iic ]
  set_property -dict [ list \
   CONFIG.IIC_FREQ_KHZ {400} \
 ] $sensor0_iic

  # Create instance: sensor1_iic, and set properties
  set sensor1_iic [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:2.0 sensor1_iic ]
  set_property -dict [ list \
   CONFIG.IIC_FREQ_KHZ {400} \
 ] $sensor1_iic
  ...
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports sensor1_iic] [get_bd_intf_pins sensor1_iic/IIC]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_hpm0_M00_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins axi_interconnect_hpm0/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_hpm0_M01_AXI [get_bd_intf_pins axi_interconnect_hpm0/M01_AXI] [get_bd_intf_pins mipi_csi2_rx0/csirxss_s_axi]
  connect_bd_intf_net -intf_net axi_interconnect_hpm0_M02_AXI [get_bd_intf_pins axi_interconnect_hpm0/M02_AXI] [get_bd_intf_pins mipi_csi2_rx1/csirxss_s_axi]
  connect_bd_intf_net -intf_net axi_interconnect_hpm0_M03_AXI [get_bd_intf_pins axi_interconnect_hpm0/M03_AXI] [get_bd_intf_pins sensor1_iic/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_hpm0_M04_AXI [get_bd_intf_pins axi_interconnect_hpm0/M04_AXI] [get_bd_intf_pins sensor0_iic/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_hpm0_M05_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins axi_interconnect_hpm0/M05_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_hpm1_M00_AXI [get_bd_intf_pins axi_interconnect_hpm1/M00_AXI] [get_bd_intf_pins mipi_csi2_rx1/ctrl]
  connect_bd_intf_net -intf_net axi_interconnect_hpm1_M03_AXI [get_bd_intf_pins axi_interconnect_hpm1/M03_AXI] [get_bd_intf_pins mipi_csi2_rx1/s_axi_CTRL1]
  connect_bd_intf_net -intf_net axi_interconnect_hpm1_M04_AXI [get_bd_intf_pins axi_interconnect_hpm1/M04_AXI] [get_bd_intf_pins mipi_csi2_rx0/s_axi_CTRL1]
  connect_bd_intf_net -intf_net axi_interconnect_hpm1_M05_AXI [get_bd_intf_pins axi_interconnect_hpm1/M05_AXI] [get_bd_intf_pins mipi_csi2_rx0/s_axi_CTRL2]
  connect_bd_intf_net -intf_net axi_interconnect_hpm1_M07_AXI [get_bd_intf_pins axi_interconnect_hpm1/M07_AXI] [get_bd_intf_pins mipi_csi2_rx0/s_axi_ctrl3]
  connect_bd_intf_net -intf_net ctrl_2 [get_bd_intf_pins axi_interconnect_hpm1/M01_AXI] [get_bd_intf_pins mipi_csi2_rx0/ctrl]
  connect_bd_intf_net -intf_net mipi_csi2_rx1_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_hp1/S00_AXI] [get_bd_intf_pins mipi_csi2_rx1/M_AXI_S2MM]
  connect_bd_intf_net -intf_net mipi_csi2_rx_M_AXI_S2MM [get_bd_intf_pins axi_interconnect_hp1/S01_AXI] [get_bd_intf_pins mipi_csi2_rx0/M_AXI_S2MM]
  connect_bd_intf_net -intf_net mipi_phy_if_0_0_1 [get_bd_intf_ports csi_mipi_phy_if1] [get_bd_intf_pins mipi_csi2_rx1/mipi_phy_if_0]
  connect_bd_intf_net -intf_net mipi_phy_if_0_1 [get_bd_intf_ports csi_mipi_phy_if0] [get_bd_intf_pins mipi_csi2_rx0/mipi_phy_if_0]
  connect_bd_intf_net -intf_net s_axi_CTRL2_1 [get_bd_intf_pins axi_interconnect_hpm1/M09_AXI] [get_bd_intf_pins mipi_csi2_rx1/s_axi_CTRL2]
  connect_bd_intf_net -intf_net s_axi_ctrl3_1 [get_bd_intf_pins axi_interconnect_hpm1/M06_AXI] [get_bd_intf_pins mipi_csi2_rx1/s_axi_ctrl3]
  connect_bd_intf_net -intf_net s_axi_ctrl_1 [get_bd_intf_pins axi_interconnect_hpm1/M02_AXI] [get_bd_intf_pins mipi_csi2_rx0/s_axi_ctrl]
  connect_bd_intf_net -intf_net s_axi_ctrl_2 [get_bd_intf_pins axi_interconnect_hpm1/M08_AXI] [get_bd_intf_pins mipi_csi2_rx1/s_axi_ctrl]
  connect_bd_intf_net -intf_net sensor_iic_IIC [get_bd_intf_ports sensor0_iic] [get_bd_intf_pins sensor0_iic/IIC]
  ...
  # Create port connections
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins interrupts0/In0]
  connect_bd_net -net clk_150mhz [get_bd_pins axi_interconnect_hp1/ACLK] [get_bd_pins axi_interconnect_hp1/M00_ACLK] [get_bd_pins axi_interconnect_hp1/S00_ACLK] [get_bd_pins axi_interconnect_hp1/S01_ACLK] [get_bd_pins axi_interconnect_hpm1/ACLK] [get_bd_pins axi_interconnect_hpm1/M00_ACLK] [get_bd_pins axi_interconnect_hpm1/M01_ACLK] [get_bd_pins axi_interconnect_hpm1/M02_ACLK] [get_bd_pins axi_interconnect_hpm1/M03_ACLK] [get_bd_pins axi_interconnect_hpm1/M04_ACLK] [get_bd_pins axi_interconnect_hpm1/M05_ACLK] [get_bd_pins axi_interconnect_hpm1/M06_ACLK] [get_bd_pins axi_interconnect_hpm1/M07_ACLK] [get_bd_pins axi_interconnect_hpm1/M08_ACLK] [get_bd_pins axi_interconnect_hpm1/M09_ACLK] [get_bd_pins axi_interconnect_hpm1/M10_ACLK] [get_bd_pins axi_interconnect_hpm1/M11_ACLK] [get_bd_pins axi_interconnect_hpm1/M12_ACLK] [get_bd_pins axi_interconnect_hpm1/M13_ACLK] [get_bd_pins axi_interconnect_hpm1/M14_ACLK] [get_bd_pins axi_interconnect_hpm1/M15_ACLK] [get_bd_pins axi_interconnect_hpm1/M16_ACLK] [get_bd_pins axi_interconnect_hpm1/M17_ACLK] [get_bd_pins axi_interconnect_hpm1/M18_ACLK] [get_bd_pins axi_interconnect_hpm1/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out4] [get_bd_pins mipi_csi2_rx0/m_axi_s2mm_aclk] [get_bd_pins mipi_csi2_rx1/m_axi_s2mm_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net clk_50mhz [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_hpm0/ACLK] [get_bd_pins axi_interconnect_hpm0/M00_ACLK] [get_bd_pins axi_interconnect_hpm0/M01_ACLK] [get_bd_pins axi_interconnect_hpm0/M02_ACLK] [get_bd_pins axi_interconnect_hpm0/M03_ACLK] [get_bd_pins axi_interconnect_hpm0/M04_ACLK] [get_bd_pins axi_interconnect_hpm0/M05_ACLK] [get_bd_pins axi_interconnect_hpm0/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins mipi_csi2_rx0/s_axi_lite_aclk] [get_bd_pins mipi_csi2_rx1/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins sensor0_iic/s_axi_aclk] [get_bd_pins sensor1_iic/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net clk_wiz_1_clk_out5 [get_bd_pins clk_wiz_1/clk_out5] [get_bd_pins mipi_csi2_rx0/dphy_clk_200M] [get_bd_pins mipi_csi2_rx1/dphy_clk_200M]
  ...
  connect_bd_net -net interrupts0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins platform_interrupts/dout]
  connect_bd_net -net interrupts0_dout1 [get_bd_pins interrupts0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net mipi_csi2_rx0_csirxss_csi_irq [get_bd_pins mipi_csi2_rx0/csirxss_csi_irq] [get_bd_pins platform_interrupts/In2]
  connect_bd_net -net mipi_csi2_rx0_s2mm_introut [get_bd_pins mipi_csi2_rx0/s2mm_introut] [get_bd_pins platform_interrupts/In3]
  connect_bd_net -net mipi_csi2_rx1_Dout [get_bd_ports sensor1_gpio_rst] [get_bd_pins mipi_csi2_rx1/Dout]
  connect_bd_net -net mipi_csi2_rx1_csirxss_csi_irq [get_bd_pins mipi_csi2_rx1/csirxss_csi_irq] [get_bd_pins platform_interrupts/In4]
  connect_bd_net -net mipi_csi2_rx1_dout1 [get_bd_ports sensor1_gpio_flash] [get_bd_ports sensor1_gpio_spi_cs_n] [get_bd_pins mipi_csi2_rx1/dout1]
  connect_bd_net -net mipi_csi2_rx1_s2mm_introut [get_bd_pins mipi_csi2_rx1/s2mm_introut] [get_bd_pins platform_interrupts/In5]
  connect_bd_net -net mipi_csi2_rx_Dout [get_bd_ports sensor0_gpio_rst] [get_bd_pins mipi_csi2_rx0/Dout]
  connect_bd_net -net proc_sys_reset_clk50_interconnect_aresetn [get_bd_pins axi_interconnect_hp1/ARESETN] [get_bd_pins axi_interconnect_hpm0/ARESETN] [get_bd_pins axi_interconnect_hpm1/ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_clk50_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_hp1/M00_ARESETN] [get_bd_pins axi_interconnect_hp1/S00_ARESETN] [get_bd_pins axi_interconnect_hp1/S01_ARESETN] [get_bd_pins axi_interconnect_hpm0/M00_ARESETN] [get_bd_pins axi_interconnect_hpm0/M01_ARESETN] [get_bd_pins axi_interconnect_hpm0/M02_ARESETN] [get_bd_pins axi_interconnect_hpm0/M03_ARESETN] [get_bd_pins axi_interconnect_hpm0/M04_ARESETN] [get_bd_pins axi_interconnect_hpm0/M05_ARESETN] [get_bd_pins axi_interconnect_hpm0/S00_ARESETN] [get_bd_pins axi_interconnect_hpm1/M00_ARESETN] [get_bd_pins axi_interconnect_hpm1/M01_ARESETN] [get_bd_pins axi_interconnect_hpm1/M02_ARESETN] [get_bd_pins axi_interconnect_hpm1/M03_ARESETN] [get_bd_pins axi_interconnect_hpm1/M04_ARESETN] [get_bd_pins axi_interconnect_hpm1/M05_ARESETN] [get_bd_pins axi_interconnect_hpm1/M06_ARESETN] [get_bd_pins axi_interconnect_hpm1/M07_ARESETN] [get_bd_pins axi_interconnect_hpm1/M08_ARESETN] [get_bd_pins axi_interconnect_hpm1/M09_ARESETN] [get_bd_pins axi_interconnect_hpm1/M10_ARESETN] [get_bd_pins axi_interconnect_hpm1/M11_ARESETN] [get_bd_pins axi_interconnect_hpm1/M12_ARESETN] [get_bd_pins axi_interconnect_hpm1/M13_ARESETN] [get_bd_pins axi_interconnect_hpm1/M14_ARESETN] [get_bd_pins axi_interconnect_hpm1/M15_ARESETN] [get_bd_pins axi_interconnect_hpm1/M16_ARESETN] [get_bd_pins axi_interconnect_hpm1/M17_ARESETN] [get_bd_pins axi_interconnect_hpm1/M18_ARESETN] [get_bd_pins axi_interconnect_hpm1/S00_ARESETN] [get_bd_pins mipi_csi2_rx0/axi_resetn] [get_bd_pins mipi_csi2_rx0/video_aresetn] [get_bd_pins mipi_csi2_rx1/axi_resetn] [get_bd_pins mipi_csi2_rx1/video_aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins sensor0_iic/s_axi_aresetn] [get_bd_pins sensor1_iic/s_axi_aresetn]
  connect_bd_net -net sensor0_iic_iic2intc_irpt [get_bd_pins platform_interrupts/In0] [get_bd_pins sensor0_iic/iic2intc_irpt]
  connect_bd_net -net sensor1_iic_iic2intc_irpt [get_bd_pins platform_interrupts/In1] [get_bd_pins sensor1_iic/iic2intc_irpt]
  connect_bd_net -net vcc_dout_gpio [get_bd_ports sensor0_gpio_flash] [get_bd_ports sensor0_gpio_spi_cs_n] [get_bd_pins mipi_csi2_rx0/dout1]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins mipi_csi2_rx0/Din] [get_bd_pins mipi_csi2_rx1/Din] [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0xA0030000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs sensor1_iic/S_AXI/Reg] SEG_axi_iic_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] SEG_axi_intc_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0060000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx0/mipi_csi2_rx_subsystem_0/csirxss_s_axi/Reg] SEG_mipi_csi2_rx_subsystem_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx1/mipi_csi2_rx_subsystem_0/csirxss_s_axi/Reg] SEG_mipi_csi2_rx_subsystem_0_Reg4
  create_bd_addr_seg -range 0x00010000 -offset 0xA00A0000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs sensor0_iic/S_AXI/Reg] SEG_sensor_iic_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0040000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx0/v_demosaic_0/s_axi_CTRL/Reg] SEG_v_demosaic_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0030000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx1/v_demosaic_0/s_axi_CTRL/Reg] SEG_v_demosaic_0_Reg9
  create_bd_addr_seg -range 0x00010000 -offset 0xB0020000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx0/v_frmbuf_wr_0/s_axi_CTRL/Reg] SEG_v_frmbuf_wr_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0050000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx1/v_frmbuf_wr_0/s_axi_CTRL/Reg] SEG_v_frmbuf_wr_0_Reg11
  create_bd_addr_seg -range 0x00010000 -offset 0xB0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx0/v_gamma_lut_0/s_axi_CTRL/Reg] SEG_v_gamma_lut_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0070000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx1/v_gamma_lut_0/s_axi_CTRL/Reg] SEG_v_gamma_lut_0_Reg13
  create_bd_addr_seg -range 0x00040000 -offset 0xB0080000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx0/v_proc_ss_scaler/s_axi_ctrl/Reg] SEG_v_proc_ss_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0060000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx0/v_proc_ss_csc/s_axi_ctrl/Reg] SEG_v_proc_ss_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xB0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx1/v_proc_ss_csc/s_axi_ctrl/Reg] SEG_v_proc_ss_csc_Reg
  create_bd_addr_seg -range 0x00040000 -offset 0xB00C0000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs mipi_csi2_rx1/v_proc_ss_scaler/s_axi_ctrl/Reg] SEG_v_proc_ss_scaler_Reg
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces mipi_csi2_rx0/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x00040000 -offset 0xFFFC0000 [get_bd_addr_spaces mipi_csi2_rx0/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces mipi_csi2_rx0/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] SEG_zynq_ultra_ps_e_0_HP1_QSPI
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces mipi_csi2_rx1/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x00040000 -offset 0xFFFC0000 [get_bd_addr_spaces mipi_csi2_rx1/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_zynq_ultra_ps_e_0_HP1_LPS_OCM
  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces mipi_csi2_rx1/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] SEG_zynq_ultra_ps_e_0_HP1_QSPI
